...
### 10.可持续性发展
- 在“找厕所”APP中，使用到高德开放平台和百度AI开放平台的API，这两大平台的可靠性保障高，精确度高，知名度高，具有一定权威性，对该APP的使用也有很大的支持作用，在一定的程度上促进了“找厕所”APP的可持续性发展。调用输入提示API、人流量统计API、路径规划API，主要是利用人流量统计和距离综合判断为用户推荐更编辑的目的地，节省用户时间，缓解严重的排队现象，提高用户旅行体验。”找厕所“APP的主要用户为女性，因为考虑到男性用户旅游在外对找厕所的需求相对较小，但在后期也会在此方面努力，使用该APP面对的用户更大众化，不局限于女性。
